    ...
    >
      ...
      <div className="relative bg-surface-raised rounded-2xl p-8 border border-white/5 group-hover:border-transparent transition-colors duration-500">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="flex items-center gap-1.5 font-mono text-xs text-accent bg-accent/10 px-3 py-1.5 rounded-full">
            <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            {project.priceRange}
          </div>
          <div className="flex items-center gap-1.5 font-mono text-xs text-muted-light border border-white/10 px-3 py-1.5 rounded-full">
            <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex items-center gap-3">
          {project.demoUrl && (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-accent text-surface text-sm font-medium rounded-lg hover:bg-accent-dim transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
              {labels.demo}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 border border-white/10 text-white text-sm rounded-lg hover:border-white/30 hover:bg-white/5 transition-all"
          >
